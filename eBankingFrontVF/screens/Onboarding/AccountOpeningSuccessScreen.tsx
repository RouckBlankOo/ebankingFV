...
const AccountOpeningSuccessScreen: React.FC = () => {
  ...
  // Show loading for 3 seconds, then show success and add EUR account
  useEffect(() => {
    const timer = setTimeout(() => {
      setIsLoading(false);

      // Add EUR account to user's cards
      addCard({
        type: "EUR",
        balance: "119.98", // Starting with balance from deposit screen
        cardNumber: "•••• •••• •••• " + Math.floor(1000 + Math.random() * 9000),
        gradient: ["#667eea", "#764ba2"], // Purple gradient for EUR
        isFrozen: false,
        isInfoHidden: false,
        limit: 10000,
      });
            ...
            {isLoading && (
              <View style={styles.infoBox}>
                <ThemedText style={styles.infoText}>
                  Meet the conditions below to avoid any delay, rejection or
                  loss of funds.
                </ThemedText>
              </View>
            )}
              ...
              <View style={styles.detailsSection}>
                <View style={styles.detailRow}>
                  ...
                  <ThemedText style={styles.detailValue}>
                    {user?.fullName?.split(" ")[0] || "SAID SAADOULI"}
                  </ThemedText>
                </View>
                ...
                <View style={styles.detailRow}>
                  ...
                  <ThemedText style={styles.detailValue}>
                    {user?.streetAddress || "sousse sahloul 34 sousse"}
                  </ThemedText>
                </View>
        ...
        {!isLoading && (
          <View style={styles.buttonContainer}>
            <TouchableOpacity
              ...
              accessibilityRole="button"
            >
              <ThemedText style={styles.depositButtonText}>Continue</ThemedText>
            </TouchableOpacity>
          </View>
        )}
      </SafeAreaView>
